...
# adjusted ETWFE
logit_me_meda <- lapply(logit_meda, marginaleffects::slopes, 
...
logit_me_meda1 <- lapply(logit_meda1, 
...
logit_me_meda2 <- lapply(logit_meda2, 
  marginaleffects::slopes, 
  newdata = cde_temp, 
  variables = "treat", 
  by = "treat",
...
# marginal effect for CDE
logit_me_meda3 <- lapply(logit_meda3, 
  marginaleffects::slopes, 
  newdata = cde_mm, 
  variables = "treat", 
  by = "treat",
